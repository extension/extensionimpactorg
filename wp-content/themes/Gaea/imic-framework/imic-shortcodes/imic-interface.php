                    ...
                    <fieldset>
                        ...
                        <div class="option">
                            ...
                            <select id="shortcode-select" name="shortcode-select">
                                ...
                                <option value="shortcode-gmap"><?php _e('Google Map', 'imic-framework-admin'); ?></option>
                                <option value="shortcode-gallery"><?php _e('Gallery', 'imic-framework-admin'); ?></option>
                                ...
                                <!--<option value="shortcode-secondary-bar"><?php //_e('Secondary Bar', 'imic-framework-admin'); ?></option>-->
                                ...
                                <option value="shortcode-fwvideo"><?php _e('Embed Video', 'imic-framework-admin'); ?></option>
                            </select>
                        </div>
                        <!--//////////////////////////////
                        ////	STAFF
                        ...
                        <div id="shortcode-staff">
                            ...
                            <div class="option">
                                <label for="staff-title"><?php _e('Title', 'imic-framework-admin'); ?></label>
                            ...
                            <div class="option">
                                <label for="staff-category"><?php _e('Staff Category', 'imic-framework-admin'); ?></label>
                            ...
                            <div class="option">
                                <label for="staff-orderby"><?php _e('OrderBy', 'imic-framework-admin'); ?></label>
                                <select id="staff-orderby" name="staff-orderby">
                                    <option value=""><?php _e('Default', 'imic-framework-admin'); ?></option>
                                    <option value="menu_order"><?php _e('Menu', 'imic-framework-admin'); ?></option>
                                    <option value="title"><?php _e('Title', 'imic-framework-admin'); ?></option>
                                </select>
                            </div>
                            <div class="option">
                                <label for="staff-order"><?php _e('Order', 'imic-framework-admin'); ?></label>
                                <select id="staff-order" name="staff-order">
                                    <option value="ASC"><?php _e('Ascending', 'imic-framework-admin'); ?></option>
                                    <option value="DESC"><?php _e('Descending', 'imic-framework-admin'); ?></option>
                                </select>
                            </div>
                        </div>
                        <!--//////////////////////////////
                        ...
                        <div id="shortcode-gmap">
                            <h5><?php _e('Google Map', 'imic-framework-admin'); ?></h5>
                            <div class="option">
                                <label for="map-address"><?php _e('Address', 'imic-framework-admin'); ?></label>
                        ...
                        ////	SECONDARY BAR
                        //////////////////////////////-->
                        <div id="shortcode-secondary-bar">
                            <h5><?php _e('Secondary Bar', 'imic-framework-admin'); ?></h5>
                            <div class="option">
                                <label for="bar-btn-image"><?php _e('Button image', 'imic-framework-admin'); ?></label>
                                <input id="bar-btn-image" name="bar-btn-image" type="text" value="" style="visibility: hidden;"/>
                                <ul class="font-icon-grid"><?php echo $icon_list; ?></ul>
                            </div>
                            <div class="option">
                                <label for="bar-title"><?php _e('Title', 'imic-framework-admin'); ?></label>
                                <input id="bar-title" name="bar-title" type="text" value=""/>
                            </div>
                            <div class="option">
                                <label for="bar-url"><?php _e('Bar Title URL', 'imic-framework-admin'); ?></label>
                                <input id="bar-url" name="bar-url" type="text" value=""/>
                            </div>
                            <div class="option">
                                <label for="bar-btn-title"><?php _e('Button Title', 'imic-framework-admin'); ?></label>
                                <input id="bar-btn-title" name="bar-btn-title" type="text" value=""/>
                            </div>
                            <div class="option">
                                <label for="bar-btn-url"><?php _e('Bar Button URL', 'imic-framework-admin'); ?></label>
                                <input id="bar-btn-url" name="bar-btn-url" type="text" value=""/>
                            </div>
                        </div>
                        <!--//////////////////////////////
                        ////	ICONS
                        ...
                        <div id="shortcode-icons-box">
                            ...
                            <div class="option">
                                ...
                                <div class="option">
                                    <label for="icon-link"><?php _e('URL', 'imic-framework-admin'); ?></label>
                                    <input id="icon-link" name="icon-link" type="text" value=""/>
                                </div>
                                <div class="option">
                                    <label for="icon-target"><?php _e('Select Icon Target', 'imic-framework-admin'); ?></label>
                                    <select id="icon-target" name="icon-target">
                                        <option value="_blank"><?php _e('Blank', 'imic-framework-admin'); ?></option>
                                        <option value="_self"><?php _e('Self', 'imic-framework-admin'); ?></option>
                                        <option value="mailto"><?php _e('Email', 'imic-framework-admin'); ?></option>
                                    </select>
                                </div>
                                <!--<div class="option">
                                ...
                                <div class="option">
                                    <label for="icon-type"><?php _e('Select Icon type', 'imic-framework-admin'); ?></label>
                                    <select id="icon-type" name="icon-type">
                                        <option value="label-default"><?php _e('Standard', 'imic-framework-admin'); ?></option>
                                        <option value="label-warning"><?php _e('Warning', 'imic-framework-admin'); ?></option>
                                        <option value="label-error"><?php _e('Error', 'imic-framework-admin'); ?></option>
                            ...
                            <div class="option">
                                    <label for="icon-box-type"><?php _e('Select Icon Box type', 'imic-framework-admin'); ?></label>
                                    <select id="icon-box-type" name="icon-box-type">
                                        <option value="with_description"><?php _e('With description', 'imic-framework-admin'); ?></option>
                                        <option value="with_out_description"><?php _e('With Out description', 'imic-framework-admin'); ?></option>
                                    </select>
                                </div>
                        </div>
                        <!--//////////////////////////////
                        ...
                        <div id="shortcode-typography">
                            ...
                            <div class="option">
                                ...
                                <select id="typography-type" name="typography-type">
                                    ...
                                    <option value="typo-div"><?php _e('Div', 'imic-framework-admin'); ?></option>
                                    ...
                                    <!--<option value="typo-hr"><?php _e('hr', 'imic-framework-admin'); ?></option>-->
                                </select>
                            </div>
                            <!-- ANCHOR TAG -->
                            <div id="typo-anchor">
                            ...
                            <div id="typo-section">
                                <h5><?php _e('Section Tag', 'imic-framework-admin'); ?></h5>
                                <div class="option">
                            ...
                            <!-- Div -->
                            <div id="typo-div">
                                <h5><?php _e('Div', 'imic-framework-admin'); ?></h5>
                                <div class="option">
                                    <label for="div-extra-class"><?php _e('Add Extra Class', 'imic-framework-admin'); ?></label>
                                    <input id="div-extra-class" name="div-extra-class" type="text" value=""/>
                                </div>
                            </div> 
                            <!-- HR -->
                            <div id="typo-hr">
                                <h5><?php _e('hr', 'imic-framework-admin'); ?></h5>
                                <div class="option">
                                    <label for="hr-extra-class"><?php _e('Add Extra Class', 'imic-framework-admin'); ?></label>
                                    <input id="hr-extra-class" name="hr-extra-class" type="text" value=""/>
                                </div>
                            </div>                            
                            <!-- LABEL TAGS -->
                            <div id="typo-label">
                        ...
                        <div id="shortcode-tabs">
                            ...
                            <div class="option">
                                <label for="tab-type"><?php _e('Tab Style', 'imic-framework-admin'); ?></label>
                                <select id="tab-type" name="tab-type">
                                    <option value="1"><?php _e('Type 1', 'imic-framework-admin'); ?></option>
                                    <option value="2"><?php _e('Type 2', 'imic-framework-admin'); ?></option>
                                </select>
                            </div>
                            <div class="option">
                                <label for="full-col"><?php _e('Full Column', 'imic-framework-admin'); ?></label>
                                <select id="full-col" name="full-col">
                       ...
                       <!--//////////////////////////////
                        ...
                        <div class="option">
                                    <label for="form-title"><?php _e('Title', 'imic-framework-admin'); ?></label>
                        ...
                        //// GALLERY	
                        //////////////////////////////-->
                        <?php $g_terms = get_terms('gallery-category');
						$gallery_terms = array();
						?>
                        <div id="shortcode-gallery">
                         <h5><?php _e('Gallery', 'imic-framework-admin'); ?></h5>
                         <div class="option">
                                <label for="gallery-title"><?php _e('Title', 'imic-framework-admin'); ?></label>
                                <input id="gallery-title" name="gallery-title" type="text" value="" />
                            </div>
                        <div class="option">
                        <label for="gallery-category"><?php _e('Gallery Categories', 'imic-framework-admin'); ?></label>
                        <select id="gallery-category" name="gallery-category">
                        <option value=""><?php _e('Select', 'imic-framework-admin'); ?></option>
                        <?php
						if(!empty($g_terms)) { 
                        ...
                        <div class="option">
                                <label for="gallery-count"><?php _e('Number of Galleries', 'imic-framework-admin'); ?></label>
                                <input id="gallery-count" name="gallery-count" type="text" value=""/>
                            </div>
                      	<div class="option">
                                <label for="gallery-column"><?php _e('Gallery Column', 'imic-framework-admin'); ?></label>
                                <select id="gallery-column" name="gallery-column">
                                    <option value="2"><?php _e('2', 'imic-framework-admin'); ?></option>
                                    <option value="3"><?php _e('3', 'imic-framework-admin'); ?></option>
                                    <option value="4"><?php _e('4', 'imic-framework-admin'); ?></option>
                                </select>
                       ...
                       //////////////////////////////-->
                        ...
                        <div class="option">
                                <label for="calendar-filter"><?php _e('Calendar Filter', 'imic-framework-admin'); ?></label>
                                <select id="calendar-filter" name="calendar-filter">
                                    <option value=""><?php _e('No', 'imic-framework-admin'); ?></option>
                                    <option value="1"><?php _e('Yes', 'imic-framework-admin'); ?></option>
                                </select>
                            </div>
                       	<div class="option">
                                <label for="calendar-preview"><?php _e('Events Preview', 'imic-framework-admin'); ?></label>
