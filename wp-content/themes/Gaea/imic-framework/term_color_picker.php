...
?>
<tr class="form-field">
    <th scope="row" valign="top"><label for="meta-color"><?php _e('Event background bolor','framework'); ?></label></th>
    <td>
        <div id="colorpicker">
            <input type="text" name="cat_meta[catBG]" class="colorpicker" size="3" style="width:80px" value="<?php echo (isset($cat_meta['catBG'])) ? $cat_meta['catBG'] : ''; ?>" />
        </div>
            <br />
        <span class="description"><?php _e('Event background color for calendar','framework'); ?></span>
            <br />
        </td>
</tr>
<?php
...
/** Save Category Meta **/
function imic_save_extra_category_fields( $term_id ) {
...
add_action ('edited_event-category', 'imic_save_extra_category_fields');
add_action('created_event-category', 'imic_save_extra_category_fields', 11, 1);
