...
class insta_gallery extends WP_Widget {
	...
	public function __construct() {
         ...
         parent::__construct(false, $name = __('Instagram Gallery','imic-framework-admin'), $widget_ops);
	}
	...
	public function widget($args, $instance) {
	   ...
	   echo $args['before_widget'];
		...
		$count;
		$accessToken;	
             wp_enqueue_script('imic_jquery_insta', IMIC_THEME_PATH . '/imic-framework/widgets/InstaGram/js/insta.js', array(), '', true);
		wp_localize_script('imic_jquery_insta','insta',array('ids'=>$username,'counts'=>$count,'token'=>$accessToken));
