...
<div class="timer" data-perc="<?php echo $number; ?>"> <span class="count" style="color:<?php echo $ncolor; ?>"><?php echo $number; ?></span> </div>
<div class="clearfix"></div>
<span class="fact" style="color:<?php echo $tcolor; ?>"><?php echo $text; ?></span>
</div>