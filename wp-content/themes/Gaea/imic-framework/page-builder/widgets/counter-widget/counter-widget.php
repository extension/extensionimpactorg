	...
	function __construct() {
		...
		parent::__construct(
			...
			array(
				'icon' => array(
					'type' => 'icon',
					'label' => __('Icon', 'imic-framework'),
				),
				'icon_color' => array(
					'type' => 'color',
					'label' => __('Icon color', 'imic-framework'),
					'default' => '#999999',
				),
  				'icon_size' => array(
					'type' => 'number',
					'label' => __('Icon size', 'imic-framework'),
					'default' => 48,
				),
				'icon_image' => array(
					'type' => 'media',
					'library' => 'image',
					'label' => __('Icon image', 'imic-framework'),
					'description' => __('Use your own icon image.', 'imic-framework'),
				),
				'number' => array(
					'type' => 'number',
