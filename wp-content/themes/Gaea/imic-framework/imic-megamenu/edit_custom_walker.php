        ...
        <li id="menu-item-<?php echo $item_id; ?>" class="<?php echo implode(' ', $classes); ?>">
            <dl class="menu-item-bar">
                ...
                <span class="item-controls">
                    ...
                    <a class="item-edit" id="edit-<?php echo $item_id; ?>" title="<?php esc_attr_e('Edit Menu Item', 'imic-framework'); ?>" href="<?php
                    ...
                    ?>"><?php _e('Edit Menu Item', 'imic-framework'); ?></a>
                </span>
                </dt>
            </dl>
              ...
              ?>
                ...
                <p class="field-custom description description-wide">
                    <label for="edit-menu-post-id-comma-<?php echo $item_id; ?>">
                        <?php _e('Enter Comma seperated value Ex-1,2,3(for  menu use M like M10)','framework'); ?><input type="text" id="edit-menu-post-id-comma-<?php echo $item_id; ?>" class="menu-post-id-comma edit-menu-item-custom"   name="menu-post-id-comma[<?php echo $item_id; ?>]" value="<?php echo ($item->menupostidcomma); ?>" /> 
                    </label>
                </p>
                <p class="field-custom description description-wide">
