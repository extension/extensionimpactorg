...
<div class="page-header" style="background-image:url(<?php echo $event_image; ?>)">
    ...
    <?php if(is_active_sidebar('page-sidebar') || $imic_options['search_sidebar'] !== '') { $class = $ContentWidth; } else { $class = 12; } ?>
    <!-- Start Body Content -->
    	...
    	<div id="content" class="content full">
    		<div class="container">
            	<div class="row">
                    ...
                    <!-- Start Sidebar -->
                    <?php if ($imic_options['search_sidebar'] !== "") { ?>
        				<div class="col-md-<?php echo $SidebarWidth; ?> sidebar right-sidebar" id="sidebar-col">
    						<?php dynamic_sidebar($imic_options['search_sidebar']); ?>
    					</div>
    				<?php }
