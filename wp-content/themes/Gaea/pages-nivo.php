...
<div class="slider-wrapper theme-default">
  		<div class="nivoslider clearfix" data-autoplay="<?php echo $autoplay; ?>" data-pagination="<?php echo $pagination; ?>" data-arrows="<?php echo $arrows; ?>" data-effect="<?php echo $effects; ?>" data-thumbs="no" data-slices="15" data-animSpeed="500" data-pauseTime="3000" data-pauseonhover="yes">
        <?php foreach($images as $image):
		$attachment_meta = imic_wp_get_attachment($image);
		?>
    	<img src=" <?php echo esc_url($attachment_meta['src']); ?> " alt="" title="<?php echo $attachment_meta['caption']; ?>">
        <?php endforeach; ?>
  		</div>
  	</div>
<?php
...
$output .= '<div class="main" role="main">
		...
		if (!empty($menu_ids[0]))
		{
			foreach($menu_ids[0] as $key=>$value)
			{
