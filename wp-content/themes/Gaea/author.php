...
<div class="page-header" style="background-image:url(<?php echo $event_image; ?>)">
    	<div class="container">
        	<div class="row">
            	...
            	<div class="col-md-6 col-sm-6 col-xs-12">
    				<h2><?php printf( __( '%s', 'framework' ), get_the_author() ); ?></h2>
                </div>
           	</div>
        </div>
    </div>
    ...
    <div class="secondary-bar">
    	<div class="container">
        	<div class="row">
            	<div class="col-md-12">
                	<span class="big"><?php printf( __( 'All posts by %s', 'framework' ), get_the_author() ); ?></span>
              	</div>
            </div>
        </div>
    </div>
    <?php if(is_active_sidebar('page-sidebar') || $imic_options['author_sidebar'] != '') { $class = $ContentWidth; } else { $class = 12; } ?>
    <!-- Start Body Content -->
    	...
    	<div id="content" class="content full">
    		<div class="container">
            	<div class="row">
                    ...
                    <!-- Start Sidebar -->
                    <?php if ($imic_options['author_sidebar'] !== "") { ?>
        				<div class="col-md-<?php echo $SidebarWidth; ?> sidebar right-sidebar" id="sidebar-col">
    						<?php dynamic_sidebar($imic_options['author_sidebar']); ?>
    					</div>
    				<?php }
