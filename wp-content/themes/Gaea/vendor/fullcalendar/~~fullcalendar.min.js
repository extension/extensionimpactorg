		...
		try{
			...
			for(var i=0;i<segs.length;i++){
				...
				while(sd.getTime() < segs[i].end.getTime()){
					...
					/* add by dharmveer */
					rowsTd.filter('.fc-day-'+formatDate(segs[i].start, 'yyyy-MM-dd')).
					wrapInner('<a title="'+segs[i].event.title+'" href="'+(segs[i].event.url!=undefined?segs[i].event.url:'javascript:;')+'"></a>');
					/* add by dharmveer end */
					addDays(sd,1);
				}
			}
