    ...
    if (have_comments()) : // if there are comments 
        ...
        <div id="comments" class="clearfix">
            <?php if (!empty($comments_by_type['comment'])) : // if there are normal comments  ?>
                <h4 class="title"><i class="fa fa-comment"></i><?php comments_number(__(' No Comments', 'framework'), __(' Comment(1)', 'framework'), __(' Comments(%)', 'framework')); ?></h3>
                <ol class="comments">
                            ...
                            <div class="row">
                                <div class="form-group">
                                    <div class="col-md-4 col-sm-4">
                                        <input type="name" class="form-control" name="author" id="author" value="<?php echo esc_attr($comment_author); ?>" size="22" tabindex="1" placeholder="<?php _e('Your name','framework'); ?>" />
                                    </div>
                                    <div class="col-md-4 col-sm-4">
                                        <input type="email" name="email" class="form-control" id="email" value="<?php echo esc_attr($comment_author_email); ?>" size="22" tabindex="2" placeholder="<?php _e('Your email','framework'); ?>" />
                                    </div>
                                    <div class="col-md-4 col-sm-4">
                                        <input type="url" class="form-control" name="url" id="url" value="<?php echo esc_attr($comment_author_url); ?>" size="22" tabindex="3" placeholder="<?php _e('Website (optional)','framework'); ?>" /></div>
                                </div>
                            </div>
                        <?php endif; ?>     
                        <div class="row">
                            <div class="form-group">
                                <div class="col-md-12">
                                    <textarea name="comment" id="comment-textarea" class="form-control" cols="8" rows="4"  tabindex="4" placeholder="<?php _e('Your comment','framework'); ?>" ></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
